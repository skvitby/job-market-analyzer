...
| `analyze` | Агрегированный Gap Analysis (US-03) | `--data` — необязательный путь к одному файлу вакансий; по умолчанию объединяются все файлы из `data/`; `--days N` — только вакансии за последние N дней | `reports/market_skills_summary.md` |
